// @ts-nocheck
export default function HeavyweightTable({ stocks = null }) {
  if (!stocks || stocks.length === 0) {
    return (
      <div className="card">
        ...
        <div className="flex items-center justify-center py-8 text-xs text-text-tertiary">— Heavyweight data unavailable</div>
      </div>
    );
  }
